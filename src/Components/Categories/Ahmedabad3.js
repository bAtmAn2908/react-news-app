...
export const Ahmedabad3 = () => {
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link"to="/ahm2" tabindex="-1" aria-disabled="true">Previous</Link>
    </li>
    <li class="page-item"><Link class="page-link"to="/ahm">1</Link></li>
    <li class="page-item"><Link class="page-link"to="/ahm2">2</Link></li>
