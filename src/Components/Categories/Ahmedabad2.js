...
import { FormatBold, FormatBoldSharp, FormatBoldTwoTone } from '@mui/icons-material'
// import './Home.css'

export const Ahmedabad2 = () => {
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link"to="/ahm" tabindex="-1" aria-disabled="true">Previous</Link>
    </li>
    <li class="page-item"><Link class="page-link"to="/ahm">1</Link></li>
    <li class="page-item disabled">
      <Link class="page-link"to="" tabindex="-1" aria-disabled="true">2 </Link>
    </li>
    <li class="page-item"><Link class="page-link"to="/ahm3">3</Link></li>
    <li class="page-item">
      <Link class="page-link"to="/ahm3">Next</Link>
    </li>
  </ul>
</div>
