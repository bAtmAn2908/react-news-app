...
export const Gujarat2 = () => {
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link"to="/gujarat" tabindex="-1" aria-disabled="true">Previous</Link>
    </li>
    <li class="page-item"><Link class="page-link"to="/gujarat">1</Link></li>
    ...
    <li class="page-item">
      <Link class="page-link"to="/gujarat3">Next</Link>
    </li>
  </ul>
</div>
