...
export const Technology2 = () => {
  ...
  const getAllNews = async()=>{
    ...
    await axios.get("https://timenews.co.in/wp-json/wp/v2/posts?categories=8&page=2").then(res=>{    
      setnews(res.data)
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link"to="/tech" tabindex="-1" aria-disabled="true">Previous</Link>
    </li>
    ...
    <li class="page-item">
      <Link class="page-link"to="/tech3">Next</Link>
    </li>
  </ul>
</div>
