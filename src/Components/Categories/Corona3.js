...
export const Corona3 = () => {
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <Link class="page-link"to="/corona2" tabindex="-1" aria-disabled="true">Previous</Link>
    </li>
    <li class="page-item"><Link class="page-link"to="/corona">1</Link></li>
    <li class="page-item"><Link class="page-link"to="/corona2">2</Link></li>
